...
#import "LGPlayerVideoRelativesCell.h"
...
FOUNDATION_EXPORT double JPlayerModuleVersionNumber;
FOUNDATION_EXPORT const unsigned char JPlayerModuleVersionString[];
